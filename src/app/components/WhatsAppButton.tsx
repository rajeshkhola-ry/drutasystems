...
export default function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center gap-2.5 pl-3 pr-5 py-3 rounded-full bg-[#25D366] text-slate-950 shadow-[0_0_18px_rgba(37,211,102,0.45)] hover:shadow-[0_0_28px_rgba(37,211,102,0.65)] hover:scale-105 transition-all duration-300"
    >
